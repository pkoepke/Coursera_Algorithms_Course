...
function splitArrayAndRecur(arrayToSort) {
    ...
    */
    var arrayToSort = arrayToSort.slice();
    var firstHalfArray = [];
...
/*
var arrayToSort, sortedArray, arraySize = 10; // Merge sort performs very quickly up to 1,000,000 elements - it takes under 2 seconds. 10 million elements slows it down to about 28 seconds. Cant' test 100 million elements because Node.js has a memory error on arrays of that size.

arrayToSort = [1,2,3,4,5,6];
sortedArray = splitArrayAndRecur(arrayToSort);
console.log("Sorting " + arrayToSort + ": " + sortedArray);
console.log("Is the array sorted? " + checkIfArrayIsSorted.checkIfArrayIsSorted(arrayToSort, sortedArray));
...
console.log("Did merge sort sort the array correctly? " + checkIfArrayIsSorted.checkIfArrayIsSorted(arrayToSort, sortedArray));
*/